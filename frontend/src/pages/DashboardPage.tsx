  ...
  return (
    <div className="relative">
      ...
      {isOpen && filteredJobs.length > 0 && (
        <ul className="absolute z-50 w-full mt-1 max-h-60 overflow-auto rounded-xl border border-violet-400/45 bg-[#1a1a2e]/95 backdrop-blur-md shadow-lg">
...
export default function DashboardPage({ onSelect }: { onSelect: (id: number) => void }) {
    ...
    for (let attempt = 0; attempt < 3; attempt += 1) {
      try {
        ...
        if (recovered) {
          ...
          setCvFile(null)
          sessionStorage.setItem('dashboard_profile_context', JSON.stringify({ skills, target_job_title: targetJobTitle, target_job_description: targetJobDescription }))
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(0,217,255,0.16),transparent_48%)]" />

      <section className="relative z-10 min-h-screen pt-28 px-6 pb-10">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="glass-card p-4 md:p-5 max-w-[760px] mx-auto">
            ...
            <button
              onClick={uploadCV}
              className="w-full py-3 rounded-2xl text-lg font-semibold bg-gradient-to-r from-violet-600 to-fuchsia-600 shadow-neon transition hover:-translate-y-0.5 disabled:opacity-65 disabled:cursor-not-allowed disabled:hover:translate-y-0"
